 ...
 * notify reader table execute finished.
 */
public class FinishedSnapshotTableReportEvent implements SourceEvent {

    private static final long serialVersionUID = 1L;

    private final List<String> finishedTableIds;

    public FinishedSnapshotTableReportEvent(List<String> finishedTableIds) {
        this.finishedTableIds = finishedTableIds;
    }

    public List<String> getFinishedTableIds() {
